...
class TestTemplates(WebserviceTest):  # pragma: no cover
    ...
    def testNonExistantTemplate(self):
        ...
        try:
            ...
            self.assertEqual(
                ex.message, "There is no template called "
                "'Non_Existant' at this service")
    ...
    def testCodesInOrder(self):
        ...
        self.assertIsNotNone(
            v, msg="Query (%s) should have a "
                   "constraint with the code 'X'" % t)
    ...
    def testTemplateConstraintParsing(self):
        ...
        self.assertEqual(
            ...
            'Company.departments.name = Farm Supplies '
            '(non-editable, locked)>', repr(t.get_constraint("B")))
