...
class List(object):
    ...
    example::
        ...
        >>> new_list = flymine.create_list(["h", "zen", "eve", "bib"], "Gene",
                                            name="My New List")
        >>>
    ...
    Lists are created from a webservice, and can be manipulated in various
    ways.
    The operations are::
        * Union: this | that
    ...
    def is_authorized(self):
        """Whether or not the current user is authorised to make changes to
                this list"""
    ...
    def set_name(self, new_name):
        ...
        Setting the list's name causes the list's name to be updated on
                the server.
        """
    ...
    def calculate_enrichment(self,
        ...
        if background is not None:
            if self._service.version < 11:
                raise ServiceError(
                    "This service does not support custom background" +
                    "populations")
    ...
    def __isub__(self, other):
        """
            Replace this list with the subtraction of the other from thislist
        """
